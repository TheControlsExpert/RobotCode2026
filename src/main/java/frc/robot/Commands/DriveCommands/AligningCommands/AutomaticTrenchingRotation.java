...
public class AutomaticTrenchingRotation extends Command {
    ...
    public AutomaticTrenchingRotation(Drive drive, DoubleSupplier xSupplier, DoubleSupplier ySupplier, double kP_rotation, CommandXboxController controller) {
        this.drive = drive;
