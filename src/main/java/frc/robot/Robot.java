...
public class Robot extends LoggedRobot {
  ...
  public static boolean useLimelightThreeGF = true;
    ...
    public void robotInit() {
      ...
      SmartDashboard.putData("Limelight 4", new InstantCommand(() -> useLimelightFour = false));
      SmartDashboard.putData("Limelight 3GS", new InstantCommand(() -> useLimelightThreeGS = false));
      SmartDashboard.putData("Limelight 3GF", new InstantCommand(() -> useLimelightThreeGF = false));
